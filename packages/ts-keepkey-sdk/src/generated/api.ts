 ...
 *
 * The version of the OpenAPI document: 0.1.70
...
export const ClientEndpointsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async status(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Status>> {
...
export const ClientEndpointsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        status(options?: any): AxiosPromise<Status> {
...
export const DeveloperEndpointsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        removePin: async (body: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('removePin', 'body', body)
...
export const DeveloperEndpointsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async removePin(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ETHSignedTx>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removePin(body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async wipe(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ETHSignedTx>> {
...
export const DeveloperEndpointsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        removePin(body: any, options?: any): AxiosPromise<ETHSignedTx> {
            return localVarFp.removePin(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {ResetDevice} resetDevice 
         ...
         * @throws {RequiredError}
         */
        wipe(body: any, options?: any): AxiosPromise<ETHSignedTx> {
...
/**
 * Request parameters for removePin operation in DeveloperEndpointsApi.
 * @export
 * @interface DeveloperEndpointsApiRemovePinRequest
 */
export interface DeveloperEndpointsApiRemovePinRequest {
    /**
     * 
     * @type {any}
     * @memberof DeveloperEndpointsApiRemovePin
     */
    readonly body: any
}
...
export class DeveloperEndpointsApi extends BaseAPI {
    ...
    /**
     * 
     * @param {DeveloperEndpointsApiRemovePinRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DeveloperEndpointsApi
     */
    public removePin(requestParameters: DeveloperEndpointsApiRemovePinRequest, options?: AxiosRequestConfig) {
        return DeveloperEndpointsApiFp(this.configuration).removePin(requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
